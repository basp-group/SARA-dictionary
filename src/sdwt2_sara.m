...
%     I (array): starting index of the tile (without overlap) [1,2].
%     dims (array): dimensions of the image tile [1,2]
%     offset (array): offset to be considered for each dictionary 
...
%                             {1,M}.
%     Ncoefs (array): number of wavelet coefficients for each scale, 
