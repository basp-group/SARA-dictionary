function x_overlap = comm2d_update_borders(x_overlap, overlap_q, overlap_south_east, overlap_south, overlap_east, Qy, Qx)
...
%     overlap_q (array): size of the left and top facet extensions [2,1].
%     overlap_south_east (array): size of the overlap for the 
%                                      south-east neighbour [2,1].
%     overlap_south (array): size of the overlap for the northern 
%                                 neighbour [2,1].
%     overlap_east (array): size of the overlap for the eastern 
%                                neighbour [2,1].
%     Qy (int): number of spatial facets along the y axis.
%     Qx (int): number of spatial facets along the x axis.
%
% Returns:
%     x_overlap (array): spatial facet with updated borders.
%
...
dest_diag = []; % up to 3 neighbours for this communication
