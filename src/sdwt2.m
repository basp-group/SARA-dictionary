...
%     dims (array): dimensions of the underlying image tile. [1,2]
%     status (array): indicates whether the facet is the first (or the
%                          last) along each dimension. [1,2]
%                          (first: -1, last: 1, none: 0, or both: NaN))
%     lo (array): low-pass analysis wavelet filter. [1,L]
%     hi (array): high-pass analysis wavelet filter. [1,L]
%     J (int): number of decomposition levels considered.
%     Ncoefs (array): number of wavelet coefficients obtained at each 
%                          scale. [J+1,1]
%
% Returns:
%     SPsitLx (array): associated wavelet coefficients.
%
