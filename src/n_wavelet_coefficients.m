...
% ----------
% m : int[:]
%     Size of the considered filters [K, 1] (1 per type of dictionary).
% N : int[2]
%     Image dimension [1, 2].
% extension_mode : string
%     Type of boundary extension ('per', 'zpd', 'sym').
% nlevel : int
...
% -------
% dims : int[:, 2]
%     Size of the coefficients at each level of the decomposition
%     [nlevel+1,2].
% s : int
