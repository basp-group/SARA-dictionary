function PsiSty = isdwt2_sara_faceting(SPsitLx, I, dims, I_overlap, dims_overlap, Ncoefs, J, wavelet, left_offset, right_offset)
    ...
    %     dims (array): facet dimension (without overlap) [1,2].
    ...
    %     left_offset (array): number of coefficients to be cropped from 
    %                               the left of the reconstructed facet [M,2].
    %     right_offset (array): number of coefficients to be cropped from 
