...
%savetoeps(gcf,'ch6figure7a',[26 10]);
figure(4);
xlabel('k');
...
savetoeps(gcf,'ch6figure7bThr',[26 10]);
figure(5);
xlabel('k');
ylabel('xhat');
%savetoeps(gcf,'ch6figure7recThr',[26 4]);
figure(6);
xlabel('p');
...
%savetoeps(gcf,'ch6figure7coefs1Thr',[2 12]);
figure(7);
xlabel('p');
...
savetoeps(gcf,'ch6figure7coefs2Thr',[6 12]);
figure(8);
xlabel('p');
...
%savetoeps(gcf,'ch6figure7coefs3Thr',[9 12]);
figure(9);
xlabel('p');
...
%savetoeps(gcf,'ch6figure7coefs4Thr',[7 12]);
