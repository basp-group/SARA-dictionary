...
project = 'SARA-dictionary'
copyright = "2022, P.-A. Thouvenin, A. Dabbech, M. Jiang, A. Abdulaziz, A. Jackson, Y. Wiaux"
...
exclude_patterns = ["_build", "Thumbs.db", ".DS_Store", "tests/", "archive/"]
